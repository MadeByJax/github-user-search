...
const Card = () => {
  return (
    <div className="md:flex bg-card-blue mt-4 rounded-xl py-8 px-6 md:p-12 text-white">
      <div className="flex gap-5">
        ...
        <div className="md:hidden">
          <h3 className="text-base">The Octocat</h3>
          <h4 className="text-xs text-accent-blue">@octocat</h4>
          <p className="text-xs mt-2">Joined 25 Jan 2011</p>
        </div>
      </div>
      {/* Medium Screen */}
      <div>
        <div className="hidden md:flex md:flex-row justify-between">
          <div>
            <h3 className="text-base md:text-2xl">The Octocat</h3>
            <h4 className="text-base text-accent-blue mt-2">@octocat</h4>
          </div>
          <p className="text-base">Joined 25 Jan 2011</p>
        </div>
        <div>
          <p className="text-sm leading-6 mt-8">
            Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec
            odio. Quisque volutpat mattis eros.
          </p>
        </div>
        <div className="flex  justify-between p-5 bg-background-blue rounded-xl mt-6">
